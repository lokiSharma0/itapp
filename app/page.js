    ...
    <section className="w-full flex-center flex-col">
      <h1 className="head_text text-center">
        ...
        <span className="orange_gradient text-center">
          Buy and Sell Anything At Anytime
        </span>
      </h1>
      <p className="desc text-center sm:flex ">
        @YouWill is an Newly Opened ecomerce websiteTo provide a seamless online
        shopping experience with a wide range of quality products at competitive
        prices. Our vission is To become the leading e-commerce platform known
        for exceptional customer service and innovative shopping solutions.{" "}
      </p>
      <div>
        <p>
